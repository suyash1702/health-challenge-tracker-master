  ...
  styles: [
    `
      .container {
        ...
        background-image: url('https://media.istockphoto.com/id/1219488386/vector/doctor-two-professional-workers-standing-on-a-yellow-background-hospital-staff-character-set.jpg?s=612x612&w=0&k=20&c=D7pzxbt-qMqFCmvAO1fsKT9AYbraTYB9a0_r7Kk6G0Y=');
        max-width: 100%;
        margin: 0 auto;
        padding: 20px;
